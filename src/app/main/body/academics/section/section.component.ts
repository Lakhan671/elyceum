...
export class SectionComponent implements OnInit {
  ...
  getSectionlist(){
    ...
    this.webService.getSectionlist(requestJson).subscribe(res=>{
      console.log(JSON.stringify(res.data))
      this.sectionLists = res.data;
  });
  }
  studentList() {
    if ((this.registerForm.value.sectionId ||this.registerForm.value.sessionId) && this.registerForm.value.semesterId) {
      var data = {
