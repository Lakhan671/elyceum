...
export class HomeService {
  ...
  POST_SHARE = this.Model.Sevice.POST_SHARE;
  POST_LIKE = this.Model.Sevice.POST_LIKE;
  POST_HIDE_DELETE=this.Model.Sevice.POST_HIDE_DELETE;
  ...
  postShare(data): Observable<any> {
    data.tokenId = this.gettokken
    return this._http.post(this.BASE_URL + this.POST_SHARE, data)
      .map(res => <any>res)
      .catch(this.handleError);
  ...
  postLike(data): Observable<any> {
    data.tokenId = this.gettokken
    return this._http.post(this.BASE_URL + this.POST_LIKE, data)
      .map(res => <any>res)
      .catch(this.handleError);

  }

  hideDeletePost(data): Observable<any> {
    data.tokenId = this.gettokken
    return this._http.post(this.BASE_URL + this.POST_HIDE_DELETE, data)
      .map(res => <any>res)
      .catch(this.handleError);
