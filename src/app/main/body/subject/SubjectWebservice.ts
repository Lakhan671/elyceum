...
export class SubjectService {
  ...
  ADD_SUBJECT_TO_SECTION=this.Model.Sevice.ADD_SUBJECT_TO_SECTION;
  ...
  addSectionToSubject(data){
    data.tokenId = this.gettokken;
    console.log(JSON.stringify(data))
    return this._http.post(this.BASE_URL + this.ADD_SUBJECT_TO_SECTION, data)
      .map(res => <any>res)
      .catch(this.handleError);
  }
