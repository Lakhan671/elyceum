...
import { LeavesNavigationModel } from 'src/app/navigation/leaves.model';
            ...
            (event) => {
                if (event instanceof NavigationEnd) {
                    if (window.location.pathname == '/auth/login'
                        ...
                        this.translationLoader.loadTranslations(navigationEnglish, navigationTurkish);
                    } else if (window.location.pathname == '/Academics/leaves/leaveType' || window.location.pathname == '/Academics/leaves') {
                        this.fuseNavigationService.setNavigationModel(new LeavesNavigationModel());
                        this.translationLoader.loadTranslations(navigationEnglish, navigationTurkish);
                    } 
